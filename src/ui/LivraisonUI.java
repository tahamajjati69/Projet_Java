...
public class LivraisonUI extends javax.swing.JInternalFrame {
    ...
    public LivraisonUI() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\mmajj\\OneDrive\\Bureau\\livrai.png")); // NOI18N
        ...
        addli.setBackground(new java.awt.Color(0, 255, 0));
        ...
        modliv.setBackground(new java.awt.Color(102, 102, 255));
        ...
        suppliv.setBackground(new java.awt.Color(255, 51, 51));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        if (statut == null || ls == null || model == null) {
            return;
        }

        List<Livraison> liste = statut.equals("Tous")
                ? ls.listeLivraisons()
                : ls.getLivraisonsParStatut(statut);
